         ...
         <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm  keyword</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @csrf
                <div class="card-body">
                  <div class="form-group ">
                    ...
                    <input type="text" class="form-control {{ $errors->first('k_name') ? 'is-invalid': '' }}" id="k_name" name="k_name" placeholder="Name...">
                     @error('k_name')
                  ...
                  <div class="form-group  ? 'is-invalid': '' }} ">
                    <label for="exampleInputEmail1">Name <span class="text-danger">(*)</span></label>
                     <textarea class="form-control {{ $errors->first('k_description') ? 'is-invalid': '' }}" name="k_description" id="k_description" cols="30" rows="10"></textarea>
                     @error('k_description')
                         <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
