<section class="slider_section s_section_two mb-75">
    <div class="slider_area slider_carousel owl-carousel">
        ...
        {{--  <div class="single_slider d-flex align-items-center" data-bgimg="{{asset('fontend/assets/img/slider/banner_2.png')}}">
            <div class="container">
               <div class="row">
                   <div class="col-12">
                       <div class="slider_content">
                            <h1>Engine oil  <span>Engine & Gearbox</span></h1>
                            <p>Exclusive Offer -30% Off This Week</p>  
        ...
        <div class="single_slider d-flex align-items-center" data-bgimg="{{asset('fontend/assets/img/slider/slider5.jpg')}}">
            <div class="container">
               <div class="row">
                   <div class="col-12">
                       <div class="slider_content">
                            <h1>High-quality <span>Tire and wheel</span> </h1>
